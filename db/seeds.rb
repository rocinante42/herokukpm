...
type_1.bubble_groups << BubbleGroup.where(name: %w(Base10HowMany Base10Produce CountAll CountTo20 NumberLine))
type_2.bubble_groups << BubbleGroup.where(name: %w(Comparison CountOn))
