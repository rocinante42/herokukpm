...
class KidsControllerTest < ActionController::TestCase
  ...
  test "should create kid" do
    assert_difference('Kid.count') do
      post :create, kid: { classroom_id: @kid.classroom_id, login_id: @kid.login_id, school_id: @kid.school_id }
    end
  ...
  test "should update kid" do
    patch :update, id: @kid, kid: { classroom_id: @kid.classroom_id, login_id: @kid.login_id, school_id: @kid.school_id }
    assert_redirected_to kid_path(assigns(:kid))
  end
