...
class EdgesControllerTest < ActionController::TestCase
  ...
  test "should create edge" do
    assert_difference('Edge.count') do
      post :create, edge: { destination_id: @edge.destination_id, poset_id: @edge.poset_id, source_id: @edge.source_id }
    end
  ...
  test "should update edge" do
    patch :update, id: @edge, edge: { destination_id: @edge.destination_id, poset_id: @edge.poset_id, source_id: @edge.source_id }
    assert_redirected_to edge_path(assigns(:edge))
  end
