...
class BubblesControllerTest < ActionController::TestCase
  ...
  test "should create bubble" do
    assert_difference('Bubble.count') do
      post :create, bubble: { bubble_group_id: @bubble.bubble_group_id, description: @bubble.description, name: @bubble.name }
    end
  ...
  test "should update bubble" do
    patch :update, id: @bubble, bubble: { bubble_group_id: @bubble.bubble_group_id, description: @bubble.description, name: @bubble.name }
    assert_redirected_to bubble_path(assigns(:bubble))
  end
